...
The Phase 2A evidence supports Case A: retain the existing 200-observation dataset and proceed to Phase 2B without densification. Phase 2B must rerun the unchanged fitting protocol and publish separately versioned authoritative artifacts before any Phase 3 integration.
